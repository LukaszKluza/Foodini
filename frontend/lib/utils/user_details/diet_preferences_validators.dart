...
String? validateDailyBudget(DailyBudget? value, BuildContext context) {
  if (value == null) {
    return AppLocalizations.of(context)!.requiredDailyBudget;
  }
  return null;
}

String? validateCookingSkill(CookingSkills? value, BuildContext context) {
  if (value == null) {
    return AppLocalizations.of(context)!.requiredCookingSkills;
  }
  return null;
}
