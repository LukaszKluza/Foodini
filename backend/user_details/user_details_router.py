...
from backend.user_details.schemas import UserDetailsResponse, UserDetailsCreate, UserDetailsUpdate
...
async def get_user_details(
    ...
    return await user_details_service.get_user_details_by_user_id(token_payload, user_id)
...
async def add_user_details(
    ...
    return await user_details_service.add_user_details(token_payload, user_details, user_id)
...
async def update_user_details(
    ...
    return await user_details_service.update_user_details(token_payload, user_details, user_id)
